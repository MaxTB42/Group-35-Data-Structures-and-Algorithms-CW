...
def dynamic_subsets(activity_list: list[tuple]) -> list[tuple]:
    ...
    """
    #Sets initial values
    av_budget = activity_list[0][0]
    av_time = activity_list[0][1]
    ...
    for i in range(num_activities-1,-1,-1):
        ...
        if budget >= act_cost and time_budget >= act_time and dp_table[budget] == dp_table[budget - act_cost] + act_enjoy:
...
def file_to_list(file_path):
    ...
    av_time = 45
    act_list.append((av_budget, av_time))
